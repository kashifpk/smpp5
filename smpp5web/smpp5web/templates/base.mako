<%!
from smpp5web.auth import is_allowed
%>
...
<head>
  ...
  <link rel="shortcut icon" href="${request.static_url('smpp5web:static/favicon.ico')}" />
  <link rel="stylesheet" href="${request.static_url('smpp5web:static/pyck.css')}" type="text/css" media="screen" charset="utf-8" />
  <link rel="stylesheet" href="http://static.pylonsproject.org/fonts/nobile/stylesheet.css" media="screen" />
  <link rel="stylesheet" href="http://static.pylonsproject.org/fonts/neuton/stylesheet.css" media="screen" />
  <!--[if lte IE 6]>
  <link rel="stylesheet" href="${request.static_url('smpp5web:static/ie6.css')}" type="text/css" media="screen" charset="utf-8" />
  <![endif]-->
