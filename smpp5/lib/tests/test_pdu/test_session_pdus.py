...
def test_01_bind_tr_rsp_encode():
    ...
    assert '00 00 00 18 80 00 00 02 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53' +\
           '54 00 50 ' == hex_convert(P.encode(), 150)


def test_02_bind_tr_rsp_decode():
    "Test Bind Transmitter Response decoding"
    data = b'\x00\x00\x00\x18\x80\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\0x50\x00'
...
def test_01_bind_rcr_encode():
    ...
    assert '00 00 00 2a 00 00 00 01 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 54 00 73 65 63 72 65 74 30 38' + \
           ' 00 53 55 42 4D 49 54 31 00 50 01 01 00 ' == hex_convert(P.encode(), 150)


def test_02_bind_rcr_decode():
    "Test Bind Receiver decoding"
    data = b'\x00\x00\x00\x2a\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\x00secret08\x00' + \
           b'SUBMIT1\x00P\x01\x01\x00'
...
def test_01_bind_rcr_rsp_encode():
    ...
    assert '00 00 00 18 80 00 00 01 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 54' +\
           '00 50 ' == hex_convert(P.encode(), 150)


def test_02_bind_rcr_rsp_decode():
    "Test Bind Receiver Response decoding"
    data = b'\x00\x00\x00\x18\x80\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\0x50\x00'
...
def test_01_bind_tcr_encode():
    ...
    assert '00 00 00 2a 00 00 00 09 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 54 00 73 65 63 72 65 74 30 38' + \
           ' 00 53 55 42 4D 49 54 31 00 50 01 01 00 ' == hex_convert(P.encode(), 150)


def test_02_bind_tcr_decode():
    "Test Bind Transceiver decoding"
    data = b'\x00\x00\x00\x2a\x00\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\x00secret08\x00' + \
           b'SUBMIT1\x00P\x01\x01\x00'
...
def test_01_bind_tcr_rsp_encode():
    ...
    assert '00 00 00 18 80 00 00 09 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 ' +\
           '54 00 50 ' == hex_convert(P.encode(), 150)


def test_02_bind_tcr_rsp_decode():
    "Test Bind Transceiver Response decoding"
    data = b'\x00\x00\x00\x18\x80\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\0x50\x00'
    P = BindTransceiverResp.decode(data)
    assert '00 00 00 18 80 00 00 09 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45' +\
...
def test_01_outbind_encode():
    ...
    assert '00 00 00 1F 00 00 00 0B 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 54 00 73 65 63 72 65 74 ' +\
           '30 38 00 ' == hex_convert(P.encode(), 150)


def test_02_outbind_decode():
    "Test Out Bind decoding"
    data = b'\x00\x00\x00\x1f\x00\x00\x00\x0B\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TESTsecret08\x00'
...
def test_01_unbind_encode():
    ...
    assert '00 00 00 10 00 00 00 06 00 00 00 00 00 00 00 01'  == hex.convert(P.encode(),150)
...
def test_01_unbind_rsp_encode():
    ...
    assert '00 00 00 10 80 00 00 06 00 00 00 00 00 00 00 01' == hex.convert(P.encode(),150)
...
def test_01_enquirelink_encode():
    ...
    assert '00 00 00 10 00 00 00 15 00 00 00 00 00 00 00 01'  == hex.convert(P.encode(),150)
...
def test_01_enquirelink_rsp_encode():
    ...
    assert '00 00 00 10 80 00 00 15 00 00 00 00 00 00 00 01'  == hex.convert(P.encode(),150)
...
def test_01_alert_notification_encode():
    ...
    P.esme_addr = CString("")
    P.ms_availability_status=TLV(1058,2)
...
def test_01_generic_nack_encode():
    ...
    assert '00 00 00 10 80 00 00 00 00 00 00 00 00 00 00 01'  == hex.convert(P.encode(),150)
    
def test_02_generic_nack_decode():
    "Test Generic_Nack decoding"
    
    data = b'\x00\x00\x00\x10\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x01'
