...
def test_01_bind_tr_rsp_encode():
    ...
    assert '00 00 00 2F 80 00 00 02 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53' +\
...
def test_01_bind_rcr_rsp_encode():
    ...
    assert '00 00 00 2F 80 00 00 01 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 54' +\
...
def test_01_bind_tcr_rsp_encode():
    ...
    assert '00 00 00 2F 80 00 00 09 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 ' +\
           '54 00 50 ' == hex_convert(P.encode(), 150)
...
def test_02_bind_tcr_rsp_decode():
    ...
    assert '00 00 00 2F 80 00 00 09 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45' +\
...
def test_01_outbind_encode():
    ...
    assert '00 00 00 2F 00 00 00 0B 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 54 00 73 65 63 72 65 74 ' +\
           '30 38 00 ' == hex_convert(P.encode(), 150)


def test_02_outbind_decode():
    "Test Out Bind decoding"
    data = b'\x00\x00\x00/\x00\x00\x00\x0B\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TESTsecret08\x00'
...
def test_01_unbind_encode():
    ...
    assert '00 00 00 2F 00 00 00 06 00 00 00 00 00 00 00 01'  == hex.convert(P.encode(),150)
    
def test_02_generic_nack_decode():
    "Test UnBind decoding"
    
    data = b'\x00\x00\x00/\x00\x00\x00\x06\x00\x00\x00\x00\x00\x00\x00\x01'
...
def test_01_unbind_rsp_encode():
    ...
    assert '00 00 00 2F 80 00 00 06 00 00 00 00 00 00 00 01' == hex.convert(P.encode(),150)
...
def test_01_enquirelink_encode():
    ...
    assert '00 00 00 2F 00 00 00 15 00 00 00 00 00 00 00 01'  == hex.convert(P.encode(),150)
    
def test_02_enquirelink_decode():
    "Test EnquireLink decoding"
    
    data = b'\x00\x00\x00/\x00\x00\x00\x15\x00\x00\x00\x00\x00\x00\x00\x01'
...
def test_01_enquirelink_rsp_encode():
    ...
    assert '00 00 00 2F 80 00 00 15 00 00 00 00 00 00 00 01'  == hex.convert(P.encode(),150)
...
def test_01_alert_notification_encode():
    ...
    assert '00 00 00 2F 00 00 01 02 00 00 00 00 00 00 00 01 53 4D 50 50 33 54 45 53 54 00 73 65 63 72 65' + \
...
def test_02_alert_notification_decode():
    ...
    data = b'\x00\x00\x00/\x00\x00\x01\x02\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TESTsecret08SUBMIT1' + \
...
def test_01_generic_nack_encode():
    ...
    assert '00 00 00 2F 80 00 00 00 00 00 00 00 00 00 00 01'  == hex.convert(P.encode(),150)
