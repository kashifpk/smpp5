...
def test_02_bind_tr_decode():
    ...
    data = b'\x00\x00\x00/\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\x00secret08\x00' + \
           b'SUBMIT1\x00P\x50\x01\x01\x00'
...
def test_02_bind_tr_rsp_decode():
    ...
    data = b'\x00\x00\x00\x18\x80\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\x00\x50'
...
def test_02_bind_rcr_rsp_decode():
    ...
    data = b'\x00\x00\x00\x18\x80\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\x00\x50'
...
def test_02_bind_tcr_rsp_decode():
    ...
    data = b'\x00\x00\x00\x18\x80\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\x00\x50'
...
def test_02_outbind_decode():
    ...
    data = b'\x00\x00\x00\x1f\x00\x00\x00\x0B\x00\x00\x00\x00\x00\x00\x00\x01SMPP3TEST\x00secret08\x00'
